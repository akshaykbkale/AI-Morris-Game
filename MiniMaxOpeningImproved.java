...
public static void main(String[] args) {
	...
	/**
	 * minimax algorithm to recursively evaluate the best move for white player, based on improved static estimation
	 * @param depth
	 * @param isWhite
	 * @param inputList
	 * @return
	...
	private static finalResult MiniMax(int depth, boolean isWhite, List<positionVal> inputList) {
		...
		{
			out.leafCount++;
			out.val = StaticEstimation.OpeningImproved(inputList);
			return out;
		}
		if(isWhite) {
